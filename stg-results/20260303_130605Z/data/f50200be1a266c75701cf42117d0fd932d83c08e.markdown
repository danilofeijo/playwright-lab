...
- generic [ref=e5]:
  ...
  - textbox "Digite seu nome" [ref=e11]: Sandra Leuschke Sr.
  - textbox "Digite seu email" [ref=e13]: sandraleuschkesr.@playwright-lab.com
  - textbox "Digite sua senha" [ref=e15]: wF40CFSGYkwM
  - generic [ref=e17]:
